        ...
        /*serviceWorkerRegistration.pushManager.getSubscription().then(function(subscription) {
          if (subscription) {
            subscription.unsubscribe().then(function(successful) {
              if (successful) {
                console.log('푸시 구독이 취소되었습니다.');
              } else {
                console.log('푸시 구독 취소 실패');
              }
            }).catch(function(error) {
              console.error('푸시 구독 취소 중 오류 발생:', error);
            });
          } else {
            console.log('현재 구독이 없습니다.');
          }
        });*/
...
function subscribe() {
    navigator.serviceWorker.ready.then(function (serviceWorkerRegistration) {
        ...
        serviceWorkerRegistration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BHkeXS0ertdkG28Wy9Ymu3jC3UDPa9ynCIfJ0U0k911pMoSkxruc8VD9lJ81731hJdZBFz4uhDHD4yj-66D6S8U=')
